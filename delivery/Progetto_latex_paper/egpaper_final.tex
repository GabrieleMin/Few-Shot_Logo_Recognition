\newcommand{\myimgwidth}{0.5\linewidth}
...
For this project, we used the LogoDet-3K dataset\cite{wang2022logodet}, which currently
 represents one of the largest and most complex benchmarks for logo recognition. we take LogoDet-3k at this link: \url{ https://github.com/Wangjing1551/LogoDet-3K-Dataset}.
...
\begin{figure}[t] % Usa [t] per posizionare in alto (meglio di [H] per CVPR)
    \centering
