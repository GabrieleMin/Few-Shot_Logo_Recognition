...
Figure \ref{fig:5} shows a qualitative example of the retrieval system's behavior in the embedding space. The image on the left represents the query (anchor), belonging to the Count Chocula brand. In the center is a positive sample of the same brand, while on the right is a negative sample belonging to a different brand.
