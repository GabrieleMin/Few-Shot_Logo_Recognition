...
Cases like \emph{Maille} highlight how the network extracts invariant features, correctly associating logos on complex backgrounds (e.g., cans on a black background). 
However, the addition of massive graphic elements, as in the case of \emph{Captain Morgan}, can push the embedding beyond the tolerance threshold, masking the brand's identity and leading to false negatives.

\begin{figure}[h]
    \centering
    \includegraphics[width=\myimgwidth]{imm/img5.pdf}
