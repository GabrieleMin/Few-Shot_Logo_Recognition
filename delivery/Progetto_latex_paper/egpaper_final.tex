...
L2 Normalization and the "Scaling Problem": Initial runs without L2 normalization revealed a fundamental vulnerability: the model minimized loss by globally expanding distances (a trivial scaling strategy). This caused a persistent upward trajectory in the distance threshold as it can be seen in Figures from 4.1 to 4.3. Introducing L2 normalization and a hidden linear layer forced the model to map logos onto a unit hypersphere, favouring threshold convergence and ensuring a more robust latent space.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{img41.pdf}
    \caption{todo}
    \label{fig:41}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{img42.pdf}
    \caption{todo}
    \label{fig:42}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{img43.pdf}
    \caption{todo}
    \label{fig:43}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{img44.pdf}
    \caption{todo}
    \label{fig:44}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{img431.pdf}
    \caption{todo}
    \label{fig:431}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{img432.pdf}
    \caption{todo}
    \label{fig:432}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{img433.pdf}
    \caption{todo}
    \label{fig:433}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{img45.pdf}
