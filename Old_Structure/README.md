...
## Objective
Train a few-shot logo detector which, starting from one or more images of the
logo to be recognized, is capable of retrieving all instances of the same logo from
a dataset.
## Dataset
LogoDet-3K-Dataset: https://github.com/Wangjing1551/LogoDet-3K-Datas 
